...
[<_distutils_hack.DistutilsMetaFinder object at 0x7febadd66410>, <class '_frozen_importlib.BuiltinImporter'>, <class '_frozen_importlib.FrozenImporter'>, <class '_frozen_importlib_external.PathFinder'>, <class '__editable___boiler_0_1_0_finder._EditableFinder'>]
...
import_module("boiler.versioning")  # full path
import_module(".mathutil", "boiler")  # relative path
import_module("boiler.v2.mathutil")  # what we want

# Parent module and child directories
absolute_name = "boiler.v2"
parent = sys.modules["boiler"]  # guaranteed
child_name = "v2"
